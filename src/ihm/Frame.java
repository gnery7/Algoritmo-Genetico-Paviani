...
public class Frame extends javax.swing.JFrame {
    ...
    public Frame() {
        super("Geovanne RA185335 Luiz Ricardo RA185675");
        initComponents();
        ...
        funcaoComboBox.addItem(new Funcoes(12, 2.0001, 10, 5000));
    }
                ...
                painelControlesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(painelControlesLayout.createSequentialGroup()
                                ...
                                .addGroup(painelControlesLayout
                                        ...
                                        .addComponent(labelFuncao, javax.swing.GroupLayout.DEFAULT_SIZE, 359,
                                                Short.MAX_VALUE)
                                        .addComponent(jScrollPane1)
                                        .addComponent(iniciar, javax.swing.GroupLayout.DEFAULT_SIZE,
                                        ...
                                        .addGroup(painelControlesLayout.createSequentialGroup()
                                                ...
                                                .addGroup(painelControlesLayout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addComponent(valorPopulacao,
                                                                javax.swing.GroupLayout.Alignment.TRAILING,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE, 57,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(valorGeracoes,
                                                                javax.swing.GroupLayout.Alignment.TRAILING,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE, 57,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                painelControlesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(painelControlesLayout.createSequentialGroup()
                                ...
                                .addGroup(painelControlesLayout
                                        ...
                                        .addComponent(funcaoComboBox, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel1))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                ...
                                .addGroup(painelControlesLayout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel6)
                                        .addComponent(valorPopulacao, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel4)
                                        .addComponent(valorCrossover, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(painelControlesLayout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(valorGeracoes, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel7)
                                        .addComponent(valorMutacao, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel5))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public void montaGraficoFuncao() {
        ...
        for (double x = Algoritimo.getFuncao().getMin(); x < Algoritimo.getFuncao().getMax(); x = x
                + Algoritimo.getFuncao().getIncrementoGrafico()) {
            double[] x2 = { x };
        ...
        public void run() {
            ...
            while (geracao < Algoritimo.getFuncao().getMaximoGeracoes()) {
                ...
                if (geracao % Algoritimo.getFuncao().getIncremento() == 0) {
                    graficoConvergencia.update(geracao, populacao,
                            populacao.getIndivduo(populacao.getNumIndividuos() - 1), populacao.getIndivduo(0),
                            Algoritimo.getFuncao().getMinimoDaFuncao());
                }
                ...
                setLog("Geração " + geracao + "\nMelhor: " + populacao.getIndivduo(0).getAptidao() + "\nMédia: "
                        ...
                        + populacao.getIndivduo(populacao.getTamPopulacao() - 1).getAptidao() + "\n");
